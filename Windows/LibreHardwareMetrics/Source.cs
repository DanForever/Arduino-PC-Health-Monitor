...
namespace LibreHardwareMetrics
{
	internal static class LibreExtensions
	{
		...
		private static Dictionary<Libre.HardwareType, HardwareType> _hardwareTypeMap = new Dictionary<Libre.HardwareType, HardwareType>()
		{
			...
			{Libre.HardwareType.SuperIO             , HardwareType.SuperIO},
			...
			{Libre.HardwareType.Cooler              , HardwareType.Cooler},
			{Libre.HardwareType.EmbeddedController  , HardwareType.EmbeddedController},
		...
		{
			{Libre.SensorType.Voltage,           SensorType.Voltage},
			{Libre.SensorType.Current,           SensorType.Current},
			{Libre.SensorType.Power,             SensorType.Power},
			...
			{Libre.SensorType.Fan,               SensorType.Fan},
